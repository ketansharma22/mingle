...
const Navbaar = () => {
  ...
  return (
    <div className='w-screen border-b-2 border-black h-1/5 bg-neutral-600 flex justify-center items-center text-white'  id='navmain'>

      <div className='w-1/3 h-full flex items-center justify-center gap-20'>
      <Link id='io' className='w-max p-2  rounded-2xl' to='/'>Home</Link>
      <Link id='io' className='w-max p-2  rounded-2xl' to='/contact'>Contact</Link>
      </div>
      <div className=' flex items-center justify-center h-full w-1/3'><img className='w-40' src={logo} /></div>
